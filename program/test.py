...
title = ImageClip("Photo1.jpg").set_start(0).set_duration(t, change_end=True).set_pos(("center","center")).set_opacity(0.7)
title = title.fx(vfx.resize, 0.4)  #Ресайз переписал в формате 0.0. Как по мне так удобнее
